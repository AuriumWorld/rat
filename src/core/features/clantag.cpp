...
void updateClantag() {
    if ((TICKCOUNTWITHPING() % 128) > 96) {
        Offsets::sendClantag(Menu::clantag, "ghub/auriumfps/aurium\xe2\x80\xa8\xe2\x80\xa8\xe2\x80\xa8");
    }
    else {
        Offsets::sendClantag(Menu::clantag, "aurium beste\xe2\x80\xa8\xe2\x80\xa8\xe2\x80\xa8");
    }
}
